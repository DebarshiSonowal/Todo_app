...
class AddDailyRoutineCard extends StatefulWidget {
  const AddDailyRoutineCard(
      {Key? key,
  ...
  @override
  State<AddDailyRoutineCard> createState() =>
      _AddDailyRoutineCardState();
}

class _AddDailyRoutineCardState extends State<AddDailyRoutineCard> {
  File? attachment;
